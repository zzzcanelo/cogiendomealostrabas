    ...
    var s = i(0)
      ...
      , r = {
        ...
        _init: function() {
            ...
            i = n(s);
            for (var a in i)
                i.hasOwnProperty(a) && t.queries.push({
                    name: a,
    ...
    var a = i(0)
      ...
      , h = {
        ...
        handleKey: function(t, e, n) {
            ...
            if (s = "undefined" == typeof u.ltr ? u : i.i(l.b)() ? r.a.extend({}, u.ltr, u.rtl) : r.a.extend({}, u.rtl, u.ltr),
            o = s[h],
            a = n[o],
            a && "function" == typeof a) {
                var d = a.apply();
      ...
      , p = function(t) {
        ...
        f(e, [{
            ...
            value: function() {
                ...
                "auto" === this.options.alignment ? this.$element.hasClass(this.options.rightClass) || i.i(h.b)() || this.$element.parents(".top-bar-right").is("*") ? (this.options.alignment = "right",
...
, function(t, e, i) {
    ...
    ,
    m.init = function(t) {
        "undefined" == typeof t.spotSwipe && (m.setupSpotSwipe(t),
      ...
      , f = function(t) {
        ...
        d(e, [{
            ...
            value: function() {
                ...
                (void 0 !== n && n === !1 || void 0 === n) && (s.length ? i.i(u.a)(s, this._reflow.bind(this)) : this._reflow())
            }
        }, {
            key: "_pauseEvents",
            value: function() {
        ...
        f(e, [{
            ...
            value: function(t, e) {
                if (!this.$element.hasClass("is-open") && !this.isRevealed) {
                    ...
                    this.options.contentScroll === !1 && (r()("body").addClass("is-off-canvas-open").on("touchmove", this._stopScrolling),
                    ...
                    this.options.autoFocus === !0 && this.$element.one(i.i(c.c)(this.$element), function() {
            ...
            value: function(t) {
                if (this.$element.hasClass("is-open") && !this.isRevealed) {
                    ...
                    this.options.contentScroll === !1 && (r()("body").removeClass("is-off-canvas-open").off("touchmove", this._stopScrolling),
      ...
      , g = function(t) {
        ...
        p(e, [{
            ...
            value: function() {
                ...
                r.a.isEmptyObject(this.rules) || this._checkMediaQueries(),
                this.$element.attr("data-mutate", this.$element.attr("data-mutate") || i.i(u.a)(6, "responsive-menu"))
            }
        }, {
            key: "_events",
            value: function() {
        ...
        v(e, [{
            ...
            value: function(t, e, n) {
                ...
                if (n)
                    ...
                    var w = a(b, m);
                    if (s = this._value(w),
                    i.i(f.b)() && !this.options.vertical && (s = this.options.end - s),
