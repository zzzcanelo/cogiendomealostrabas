        ...
        if (!t(o).data("bxSlider")) {
            var l = function() {
              ...
              , g = function() {
                ...
                s.initialized = !0,
                s.settings.responsive && t(window).on("resize", Z),
                s.settings.auto && s.settings.autoStart && (f() > 1 || s.settings.autoSlideForOnePage) && L(),
                s.settings.ticker && O(),
                s.settings.pager && z(s.settings.startSlide),
                s.settings.controls && D(),
                s.settings.touchEnabled && !s.settings.ticker && B(),
                s.settings.keyboardEnabled && !s.settings.ticker && t(document).keydown(N)
            }
              , p = function() {
                var e = 0
                  , n = t();
              ...
              , F = function(t) {
                var e, i, n = t || s.settings.speed, r = {
                    left: 0,
                    top: 0
                }, a = {
                    left: 0,
              ...
              , B = function() {
                ...
                s.viewport.on("touchstart MSPointerDown pointerdown", X),
              ...
              , X = function(t) {
                if ("touchstart" === t.type || 0 === t.button)
                    ...
                    s.working)
                        ...
                        s.hasMove = !1,
                        s.viewport.on("touchmove MSPointerMove pointermove", V),
                        s.viewport.on("touchend MSPointerUp pointerup", R),
                        s.viewport.on("MSPointerCancel pointercancel", Y)
                    }
            }
              , Y = function(t) {
                t.preventDefault(),
                ...
                s.controls.el.removeClass("disabled"),
                s.viewport.off("MSPointerCancel pointercancel", Y),
                s.viewport.off("touchmove MSPointerMove pointermove", V),
                s.viewport.off("touchend MSPointerUp pointerup", R),
            ...
            return o.goToSlide = function(e, i) {
                ...
                !s.working && s.active.index !== s.oldIndex) {
                    ...
                    !s.settings.infiniteLoop && s.carousel && s.active.last ? "horizontal" === s.settings.mode ? (g = (u = s.children.eq(s.children.length - 1)).position(),
                    ...
                    g = (u = o.children(".bx-clone").eq(r)).position()) : "next" === i && 0 === s.active.index ? (g = o.find("> .bx-clone").eq(s.settings.maxSlides).position(),
                    ...
                    s.working = !1),
                    s.settings.ariaHidden && U(s.active.index * x())
                }
            }
            ,
            ...
            o.stopAuto = function(t) {
                ...
                s.settings.autoControls && !0 !== t && q("start"))
            }
            ,
            ...
            o.destroySlider = function() {
                ...
                s.settings.responsive && t(window).off("resize", Z),
                s.settings.keyboardEnabled && t(document).off("keydown", N),
